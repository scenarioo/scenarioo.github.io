...
**Note: This tutorial is still work in progress and may be incomplete in some places. <br/>
Please refer to our <a href="https://github.com/scenarioo/scenarioo/wiki" target="_blank">Wiki</a> for further information.**

The goal of this tutorial is to integrate Scenarioo in a minimal way to demonstrate its basics.

This tutorial uses **Selenium** with Java and the **Scenarioo Writer Library for Java**.
