...
We are testing a static GitHub website available on <a href="http://scenarioo.github.io/scenarioo-hello-world-app/index.html" target="_blank" />. There are two tests for one use case with two different scenarios:
